...
/**
 * Servlet implementation class VisitorLogDetails
 */
@WebServlet("/VisitorLogDetails")
public class VisitorLogDetails extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rsd = request.getRequestDispatcher("VisitorLogDetails.jsp");
