...
/**
 * Servlet implementation class VisitorDetails
 */
@WebServlet("/VisitorDetails")
public class VisitorDetails extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rsd = request.getRequestDispatcher("VisitorDetails.jsp");
